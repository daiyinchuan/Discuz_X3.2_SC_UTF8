	...
	<div class="comiis_main_r comiis_rollybox">
		<div id="comiis_rollbox">
			...
			<div class="comiis_irbox cl">
				<div class="comiis_irbox_tit cl">
					<span><a href="#" target="_blank">更多</a></span><h2>小米学院</h2>
				</div>
			...
			<div class="comiis_irbox">
				<div class="comiis_irbox_tit cl">
					<span><a href="misc.php?mod=ranklist&type=member" target="_blank">更多</a></span><h2>明星用户</h2>
				</div>
...
<div class="comiis_ibox cl">
	...
	<!--[diy=comiis_ibox_tch]--><div id="comiis_ibox_tch" class="area"></div><!--[/diy]-->
</div>
...
function comiis_open_fs(url, text) {
	window.open("http://v.t.sina.com.cn/share/share.php?url={$_G['siteurl']}" + encodeURIComponent(url) + "&title=" + encodeURIComponent(text));
}
</script>
