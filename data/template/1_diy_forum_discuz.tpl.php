...
<?php } ?>
<!--[diy=diy_chart]--><div id="diy_chart" class="area"><div id="tablzCJQn" class="frame-tab move-span cl"><div id="tablzCJQn_title" class="tab-title title column cl" switchtype="click"><span class="titletext">tab标签</span></div><div id="tablzCJQn_content" class="tb-c"></div><script type="text/javascript">initTab("tablzCJQn","click");</script></div></div><!--[/diy]-->
<div class="mn">
